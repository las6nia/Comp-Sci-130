package Lecture21; //make a new package under the same folder
import java.util.Scanner;

public class myLibrary { //change to your class name because this will be your library name, do "myLibrary" so you don't have to change everything in original code
